...
public class IntroScreen {
    ...
    private void deliveryCreation() {
        ...
        if (existingDel.isPresent()) {
            ...
            delivery = new Delivery(dp, timestamp, deliveryDataMapper, deliveryPersonMapper);
    ...
    private void tracker() {
        Scanner s = new Scanner(System.in);
        System.out.println("type R to request the remaining deliverytime.");
        System.out.println("type C to cancel the order (only possible within 5 minutes after ordering)");
        while(s.hasNext()) {
